  ...
  const fetchComments = async () => {
    ...
    try {
      ...
      if (data.comments.length === 0) {
        setError('No comments comments found')
        return
      }
      ...
      <div className="container">
        ...
        {loading && (
          <div className="loading-state">
            ...
            <div className="loading-text">Searching for comments comments...</div>
            {prInfo.owner && (
        ...
        <div className="privacy-disclaimer">
          <p>
            ...
            and are used solely to fetch comments comments from GitHub&apos;s API. You are solely responsible for 
